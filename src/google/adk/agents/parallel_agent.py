...
async def _merge_agent_run(
  ...
  # TODO - replace propagate_exceptions with asyncio.TaskGroup once Python 3.9
  ...
  try:
    ...
    # TODO - replace manual cancellations with asyncio.TaskGroup once Python
    # 3.9 is no longer supported.
    for task in tasks:
      task.cancel()
